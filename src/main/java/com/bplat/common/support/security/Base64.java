package com.bplat.common.support.security;
...
public class Base64 {
	...
	public static byte[] decode(String value) throws Exception {
		...
		if (value == null || value.length() == 0) {
			...
			// The length of the string must be a multiple of 4.
			if ((value.length() % 4) != 0)
				throw new BplatException("The length of a Base64 string must be a multiple of 4.");
			...
			for (int i = 0; i < valueSize; i++) {
				...
				throw new BplatException("An invalid character is found in the Base64 string.");
			}
